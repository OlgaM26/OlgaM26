...
Интерактивная веб-библиотека с визуальным книжным шкафом.

Проект создан для изучения:

структуры Next.js приложений
работы с React компонентами
UI логики и взаимодействий
...
🤖 Telegram-бот рекомендатель фильмов

Telegram-бот, который помогает подбирать фильмы на основе предпочтений пользователя.
...
🔗 GitHub:
https://github.com/OlgaM26/movieforNastyabot
